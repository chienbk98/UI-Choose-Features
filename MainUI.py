...
# Form implementation generated from reading ui file '.\ThreeCAMsFinal.ui'
#
...
# All function
 ...
 # Function for image processing
    ...
    def mouseEventCAM3(self, event):
        if self.removeCAM3.isEnabled() and (not self.startCAM3.isEnabled()) and self.flag_CAM3 == True:
            x = event.pos().x()
            y = event.pos().y()
